  ...
  render(){
    return (
      <div className="container-fluid">
           <img src={Bio} alt="physics" />  
        <div className="grid-container">
            <div className="grid-child">
            <h1>BIOLOGY  <button className="button" onclick="#">ENROLL NOW</button></h1> 
...
For instance, discoveries such as viruses have scrutinized traditional definitions and pushed scientists to look at life from a whole new perspective. </p>
            ...
            <i  className='fas'>&#xf103;</i><span>PLANT BIOLOGY</span>
            ...
            <div className="dropdown">
            <i  className='fas'>&#xf103;</i><span>CELL BIOLOGY</span>
            <div className="dropdown-content">
            ...
            <div className="dropdown">
            <i  className='fas'>&#xf103;</i><span>HUMAN ANATOMY</span>
            <div className="dropdown-content">
            ...
            <div className="dropdown">
            <i  className='fas'>&#xf103;</i><span>MICROBIOLOGY</span>
            <div className="dropdown-content">
            ...
            <div className="dropdown">
            <i  className='fas'>&#xf103;</i><span>ZOOLOGY</span>
            <div className="dropdown-content">
            ...
            <br/> <hr />
                ...
                <i className='fas'>&#xf254;</i><span id="heading">LENGTH  : </span><span>     5-Weeks</span><br /><hr />
                <i  className='fas'>&#xf3fd;</i><span id="heading">EFFORT  : </span><span>     2-3 hours per week</span><br /><hr />
                <i  className='fas'>&#xf02b;</i><span id="heading">PRICE  :   </span><span>    Free</span><br /><hr />
                ...
                <i className='fas'>&#xf5da;</i><span id="heading">COURSE TYPE  :</span><span>   Self-paced</span><br /><hr /></div>
                </div>
    ...
    <img className="card-img-top" src={Mavatar} alt="Card image"  />
      <h4 className="card-text">Noah Dawson</h4></div>
      </div>
      
                <div className="card">
    <div className="card-body">
    <img className="card-img-top" src={Favatar} alt="Card image"  />
      <h4 className="card-text">Olivia Ashley</h4></div>
      </div>
    ...
    <img className="card-img-top" src={M1avatar} alt="Card image"  />
      <h4 className="card-text">Benjamin Cohen</h4></div>
      </div>
      </div>
      <br />
