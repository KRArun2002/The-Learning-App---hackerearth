...
class Course extends React.Component {
  ...
  render(){
    return (
      <div className="container-fluid">
        ...
        <div className="grid-container">
            ...
            <i  className='fas'>&#xf103;</i><span>MOTION AND FORCES</span>
            ...
            <div className="dropdown">
            <i  className='fas'>&#xf103;</i><span>CONSERVATION OF ENERGY</span>
            <div className="dropdown-content">
            ...
            <div className="dropdown">
            <i  className='fas'>&#xf103;</i><span>ELECTRICITY</span>
            <div className="dropdown-content">
            ...
            <div className="dropdown">
            <i  className='fas'>&#xf103;</i><span>MAGNETISM</span>
            <div className="dropdown-content">
            ...
            <div className="dropdown">
            <i  className='fas'>&#xf103;</i><span>GRAVITY</span>
            <div className="dropdown-content">
    ...
    <img className="card-img-top" src={Mavatar} alt="Card image"  />
      <h4 className="card-text">John Doe</h4></div>
      </div>

      <div className="card ">
    <div className="card-body">
    <img className="card-img-top" src={Favatar} alt="Card image"  />
      <h4 className="card-text">Chloe Decker</h4></div>
      </div>
    ...
    <img className="card-img-top" src={M1avatar} alt="Card image"  />
      <h4 className="card-text">Lucifer Star</h4></div>
      </div>
      </div>
      <br />
